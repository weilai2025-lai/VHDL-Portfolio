...
SIGNAL \c0|c_middle~0_combout\ : std_logic;
SIGNAL \b[2]~input_o\ : std_logic;
SIGNAL \f1|p~combout\ : std_logic;
SIGNAL \c0|c_middle~1_combout\ : std_logic;
SIGNAL \f2|s~combout\ : std_logic;
SIGNAL \c0|c_middle~2_combout\ : std_logic;
SIGNAL \a[3]~input_o\ : std_logic;
SIGNAL \b[3]~input_o\ : std_logic;
SIGNAL \c0|c_middle~3_combout\ : std_logic;
SIGNAL \c0|c_middle[2]~4_combout\ : std_logic;
...
SIGNAL \c0|cout~3_combout\ : std_logic;
...
\c0|c_middle~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c_middle~0_combout\ = (\b[1]~input_o\ & ((\a[1]~input_o\) # ((\b[0]~input_o\ & \a[0]~input_o\)))) # (!\b[1]~input_o\ & (\a[1]~input_o\ & (\b[0]~input_o\ & \a[0]~input_o\)))
...
\f1|p\ : cycloneiv_lcell_comb
-- Equation(s):
-- \f1|p~combout\ = (\a[1]~input_o\) # (\b[1]~input_o\)
...
\c0|c_middle~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c_middle~1_combout\ = (\cin~input_o\ & (\f1|p~combout\ & ((\b[0]~input_o\) # (\a[0]~input_o\))))
...
PORT MAP (
	...
	datac => \b[0]~input_o\,
	datad => \a[0]~input_o\,
	combout => \c0|c_middle~1_combout\);

-- Location: LCCOMB_X18_Y1_N4
\f2|s\ : cycloneiv_lcell_comb
-- Equation(s):
-- \f2|s~combout\ = \a[2]~input_o\ $ (\b[2]~input_o\ $ (((\c0|c_middle~0_combout\) # (\c0|c_middle~1_combout\))))
...
PORT MAP (
	dataa => \a[2]~input_o\,
	datab => \c0|c_middle~0_combout\,
	datac => \b[2]~input_o\,
	datad => \c0|c_middle~1_combout\,
	combout => \f2|s~combout\);

-- Location: LCCOMB_X18_Y1_N22
\c0|c_middle~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c_middle~2_combout\ = (\a[2]~input_o\ & ((\b[2]~input_o\) # ((\a[1]~input_o\ & \b[1]~input_o\)))) # (!\a[2]~input_o\ & (\a[1]~input_o\ & (\b[2]~input_o\ & \b[1]~input_o\)))
...
-- Equation(s):
-- \c0|c_middle~3_combout\ = (\b[0]~input_o\ & (\a[0]~input_o\ & ((\b[1]~input_o\) # (\a[1]~input_o\))))
...
\c0|c_middle[2]~4\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|c_middle[2]~4_combout\ = (\c0|c_middle~3_combout\) # ((\c0|c_middle~1_combout\ & ((\a[2]~input_o\) # (\b[2]~input_o\))))
...
PORT MAP (
	dataa => \a[2]~input_o\,
	datab => \c0|c_middle~3_combout\,
	datac => \b[2]~input_o\,
	datad => \c0|c_middle~1_combout\,
	combout => \c0|c_middle[2]~4_combout\);

-- Location: LCCOMB_X18_Y1_N20
\f3|s\ : cycloneiv_lcell_comb
-- Equation(s):
-- \f3|s~combout\ = \a[3]~input_o\ $ (\b[3]~input_o\ $ (((\c0|c_middle~2_combout\) # (\c0|c_middle[2]~4_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \c0|c_middle~2_combout\,
	datab => \a[3]~input_o\,
	datac => \b[3]~input_o\,
	datad => \c0|c_middle[2]~4_combout\,
	combout => \f3|s~combout\);

-- Location: LCCOMB_X18_Y1_N6
\c0|cout~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|cout~0_combout\ = (\cin~input_o\ & ((\b[0]~input_o\) # (\a[0]~input_o\))) # (!\cin~input_o\ & (\b[0]~input_o\ & \a[0]~input_o\))
...
-- Equation(s):
-- \c0|cout~1_combout\ = (\c0|cout~0_combout\ & ((\a[1]~input_o\) # (\b[1]~input_o\))) # (!\c0|cout~0_combout\ & (\a[1]~input_o\ & \b[1]~input_o\))
...
-- Equation(s):
-- \c0|cout~2_combout\ = (\a[2]~input_o\ & ((\c0|cout~1_combout\) # (\b[2]~input_o\))) # (!\a[2]~input_o\ & (\c0|cout~1_combout\ & \b[2]~input_o\))
...
PORT MAP (
	dataa => \a[2]~input_o\,
	datab => \c0|cout~1_combout\,
	datac => \b[2]~input_o\,
	combout => \c0|cout~2_combout\);

-- Location: LCCOMB_X18_Y1_N28
\c0|cout~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \c0|cout~3_combout\ = (\a[3]~input_o\ & ((\b[3]~input_o\) # (\c0|cout~2_combout\))) # (!\a[3]~input_o\ & (\b[3]~input_o\ & \c0|cout~2_combout\))
