...
# Generated on: Wed Oct 29 08:42:10 CDT 2025 (Wed Oct 29 13:42:10 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/DNN/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/DNN -revised fv_map
...
read_design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab  -vhdl 93  ../nn_config.vhd -vhdl 93  ../Weight_Memory.vhd -vhdl 93  ../Sig_ROM.vhd -vhdl 93  ../neuron.vhd -vhdl 93  ../maxFinder.vhd -vhdl 93  ../Layer_1.vhd -vhdl 93  ../Layer_2.vhd -vhdl 93  ../Layer_3.vhd -vhdl 93  ../Layer_4.vhd -vhdl 93  ../DNN.vhd
elaborate_design -golden -root {DNN} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/DNN/fv_map.v.gz
elaborate_design -revised -root {DNN}
...
#add_name_alias fv/DNN/fv_map.singlebit.original_name.alias.json.gz -revised
