...
end entity bullet_top_top;


architecture rtl of bullet_top_top is
...
begin
-----------------------------------------------------
	 u_mgr: entity work.bullet_top_manager
    generic map(
      N_BULLETS => N_BULLETS
    )
    port map(
...
-------------------------------------------------------
  gen_bullets: for i in 0 to N_BULLETS-1 generate
    u_bullet: entity work.tank_bullet_top_refine
      generic map(
        SCREEN_WIDTH  => 640,
        SCREEN_HEIGHT => 480,
